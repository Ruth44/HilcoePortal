...
<html>
    ...
    <body>
        <div class="header">
            ...
            <h1 class="portal">AN INTERACTIVE APP FOR HILCOE</h1>
            <p class="portal-2">Learning without Walls</p>
            <a class="login" href="login.php">Log In</a>
            <a class="register" href="register.php">Register</a>
        </div>
        <div class="home">
            <h1>HILCOE WELCOMES <br>YOU</h1>
        </div>
        <div class="about">
           ...
           <div class="howitworks">
               ...
               <p>​You are one login away from making your learning process much easier. 
                  ...
                  check out announcements very easily.</p>
                     <br>
